...
Консоль может иметь несколько уровней логирования (log levels). Количество и именование уровней логирования зависит от реализации.
...
Выводит сообщение на уровне отладка (_debug_ или _verbose_).
