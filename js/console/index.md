...
Отображает объект в виде списка свойств. В отличии от других методов логирования, `console.dir()` не отображает никакие дополнительные текстовые сообщения.
...
```
В браузерах это позволяет анализировать DOM-элементы как JavaScript объекты.

Node.js или Deno поддерживают дополнительные параметры, позволяющие изменять отображение свойств:
```js
